...
\begin{itemize}
	\setlength{\itemsep}{5pt} %Ajoute de l'espace entre les items
...
\begin{itemize}
\setlength{\itemsep}{10pt} %Ajoute de l'espace entre les items
...
\includepdf[pages={1}]{evaluation/EvaluationStageESI2015Mourad.pdf}
\chapter{Conclusion}
\paragraph{}
...
\nocite{*} %Pour citer toutes les références de mabib.bib sans les afficher. Ainsi, elles apparaitront toutes dans la bibliographie
\printbibliography
